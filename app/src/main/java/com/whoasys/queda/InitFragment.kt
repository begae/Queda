...
class InitFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val b = FragmentInitBinding.inflate(inflater, container, false)
        ...
        val team = arrayOf(begae, kimsmj, hagaji, acctract)
        ...
        val library = Store("계명대학교 성서캠퍼스 동산도서관",
            "012-34-78901",
            "대구 달서구 달구벌대로 1095",
            35.856418, 128.487185, "053-580-5682",
            "08:00 - 23:00")
        ...
        val school = arrayOf(library, engineeringDept, naturalScienceDept, mainStadium)
        var storeId: Int = 0
